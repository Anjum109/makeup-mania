...
export default function SpaTopic() {
  return (
    <div className='grid grid-cols-1 lg:grid-cols-2 gap-5 mt-12 '>
        <div className=' bg-[#f6d6f1] hover:shadow-xl  flex w-full'>
...
<button className='flex  items-center gap-1 lg:gap-3  mx-12 px-3 py-2 border-green-300 rounded-xl mt-5 border-2 bg-white font-bold text-[18px] hover:bg-green-200 '>
<FaShoppingCart/>
<p className='text-[12px]'>Shop Now</p>
        ...
        <div className=' bg-[#d7f9cd]  hover:shadow-xl flex w-full'>
        <div className='w-[40%]'>
