...
export default function SpaTopic() {
  return (
    <div className='grid grid-cols-1 lg:grid-cols-2 gap-5 mt-12 '>
        <div className=' bg-[#f6d6f1] hover:shadow-xl  flex w-full cursor-pointer' style={{borderBottomLeftRadius:'30px', borderTopRightRadius:'30px'}}>
...
<p className='text-[12px]'>Shop Now</p>
        ...
        <div className=' bg-[#d7f9cd]  hover:shadow-xl flex w-full cursor-pointer' style={{borderBottomLeftRadius:'30px', borderTopRightRadius:'30px'}}>
        <div className='w-[40%]'>
              <Image src={img2} alt='img1' className='h-full' style={{borderBottomLeftRadius:'30px', }}/>
            </div>
