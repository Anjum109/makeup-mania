    ...
    return (
        <div className='pinkf'>
            <div className='py-20 max-w-screen-lg mx-auto'>
                ...
                <div className=' gap-5 mt-20 mx-5 lg:mx-0 '>
                    <Slider {...settings}>
                        {/* 1 */}
                        <div>
                        ...
                        {/* 3 */}
                        <div>
                            <div className='flex flex-col h-[300px] mr-2 justify-center items-center bg-pink-200 hover:bg-pink-50 transition-all duration-1000 hover:border-2 hover:border-pink-200 p-5 cursor-pointer ' style={{ borderTopLeftRadius: '100px', borderTopRightRadius: '200px', borderBottomLeftRadius: '80px', borderBottomRightRadius: '90px' }}>
                                <div>
